...
ARIM_Arrow::ARIM_Arrow() //생성자
{
	...
	//[스테틱메시 컴포넌트 추가] ★★★현재 총알과 동일한 값으로 세팅 됨. 추후 변경 필요
	...
	//[발사체 컴포넌트 초깃값 설정] ★★★현재 총알과 동일한 값으로 세팅 됨. 추후 변경 필요
...
// Called every frame
void ARIM_Arrow::Tick(float DeltaTime)
{
